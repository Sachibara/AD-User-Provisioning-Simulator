window.AD_SIM_DEMO = (() => {
  ...
  const users = [
    {id:1,first_name:"Alyssa",last_name:"Reyes",display_name:"Alyssa Reyes",username:"areyes",upn:"areyes@corp.local",department:"Finance",title:"Finance Analyst",ou_id:2,template_id:2,manager:"Carla Mendoza",status:"Active",enabled:true,groups:[1,2,7],expiry:"",must_reset_password:false,created_at:ago(720),updated_at:ago(2)},
    {id:2,first_name:"Nina",last_name:"Cruz",display_name:"Nina Cruz",username:"ncruz",upn:"ncruz@corp.local",department:"Human Resources",title:"HR Specialist",ou_id:3,template_id:3,manager:"Andrea Lim",status:"Active",enabled:true,groups:[1,3,7],expiry:"",must_reset_password:false,created_at:ago(1000),updated_at:ago(6)},
    ...
    {id:6,first_name:"Mika",last_name:"Torres",display_name:"Mika Torres",username:"mtorres",upn:"mtorres@corp.local",department:"Marketing",title:"Marketing Associate",ou_id:1,template_id:1,manager:"Marketing Lead",status:"Disabled",enabled:false,groups:[1,7],expiry:"",must_reset_password:false,created_at:ago(600),updated_at:ago(24)},
    {id:7,first_name:"Paolo",last_name:"Garcia",display_name:"Paolo Garcia",username:"pgarcia",upn:"pgarcia@corp.local",department:"Finance",title:"Finance Contractor",ou_id:2,template_id:2,manager:"Carla Mendoza",status:"Active",enabled:true,groups:[1,2,7],expiry:future(18),must_reset_password:true,created_at:ago(120),updated_at:ago(2)},
    {id:8,first_name:"Lea",last_name:"Ramos",display_name:"Lea Ramos",username:"lramos",upn:"lramos@corp.local",department:"Operations",title:"Operations Associate",ou_id:7,template_id:6,manager:"Victor Tan",status:"Offboarded",enabled:false,groups:[],expiry:"",must_reset_password:false,created_at:ago(1800),updated_at:ago(48)}
  ];
